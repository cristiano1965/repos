...
public class CustomersController : ControllerBase
{
    ...
    [HttpGet("{id}", Name = nameof(GetCustomer))] //named route; gi viene anche assegnato un nome in modo che possa essere richiamata anche dalla route create, dopo che questa avrà creato il customer
    ...
    public async Task<IActionResult> Delete(string id)
    {
        ...
        {
            return BadRequest( // 400 Bar request
